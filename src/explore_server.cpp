...
*/
  ...
  private:
    ...
    boost::shared_ptr <FrontierSearch> frontier_search_;
...
//        geometry_msgs::PoseStamped eval_pose_msg;
//
//        //provide current robot pose to the frontier search service request
//        tf::poseStampedTFToMsg(robot_pose, eval_pose_msg);
//
...
//          if (as_.isActive())
//          {
//            move_client_.sendGoal(move_client_goal_, boost::bind(&ExplorationServer::doneMovingCb, this, _1, _2), 0, boost::bind(&ExplorationServer::feedbackMovingCb, this, _1));
//            moving_ = true;
//          }
//          lock.unlock();
//        }
...
int main(int argc, char **argv)
{
  ...
  frontier_exploration::ExplorationServer server(ros::this_node::getName());
  ros::spin();
  return 0;
}
