...
namespace frontier_exploration
{
  ...
  FrontierSearch::FrontierSearch(boost::shared_ptr < costmap_2d::Costmap2DROS > costmap_ros) : costmap_ros_(costmap_ros)
  {
  }
